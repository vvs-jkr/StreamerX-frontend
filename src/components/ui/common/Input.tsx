		...
		return (
			<input
				...
				className={cn(
					...
					'data-[state=error]:border-destructive data-[state=error]:focus:border-destructive',
					'data-[error=true]:border-destructive data-[error=true]:focus:border-destructive',
					className
				)}
				ref={ref}
				{...props}
